...
<div class="product-template-default single single-product postid-44473 theme-electro woocommerce woocommerce-page woocommerce-no-js full-width normal wpb-js-composer js-comp-ver-6.7.0 vc_responsive">
	<div id="content" class="site-content" tabindex="-1">
                    <div class="container">
                        <nav class="woocommerce-breadcrumb"><a href="<c:url value="/"/>">Trang chủ</a><span style="margin-left:20px; margin-right: 20px"><i class="fa fa-angle-right"></i></span><a href="<c:url value="/cua-hang/?s=${ product.id_hangsx }" />"> ${ product.hangsx } </a><span class="delimiter"><i class="fa fa-angle-right"></i></span>${ product.name }</nav>
